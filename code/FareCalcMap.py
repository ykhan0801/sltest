...
fare_zone_data = pd.read_csv(os.path.join(data_path, "OD_Pairs.csv"), encoding='unicode_escape')
fares_df = pd.read_csv(os.path.join(data_path, "Fares.csv"), encoding='unicode_escape')
...
rail_nodes = gpd.read_file(os.path.join(gis_path, "Irish_Rail_Stations.shp"), encoding='unicode_escape')
city_zone = gpd.read_file(os.path.join(gis_path, "City_Zone_Boundary.shp"), encoding='unicode_escape')
commuter_zone = gpd.read_file(os.path.join(gis_path, "Commuter_Zone_Boundary.shp"), encoding='unicode_escape')
